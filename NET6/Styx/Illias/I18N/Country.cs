...
namespace org.GraphDefined.Vanaheimr.Illias
{
                           ...
                           IComparable
    {
        ...
        public static readonly Country Afghanistan                              = new Country(new I18NString(Languages.en, "Afghanistan"),                                    "AF", "AFG", 004, 93);
        public static readonly Country AlandIslands                             = new Country(new I18NString(Languages.en, "Åland Islands"),                                  "AX", "ALA", 248, 35818);
        public static readonly Country Albania                                  = new Country(new I18NString(Languages.en, "Albania"),                                        "AL", "ALB", 008, 355);
        public static readonly Country Algeria                                  = new Country(new I18NString(Languages.en, "Algeria"),                                        "DZ", "DZA", 012, 213);
        public static readonly Country AmericanSamoa                            = new Country(new I18NString(Languages.en, "American Samoa"),                                 "AS", "ASM", 016, 1684);
        public static readonly Country Andorra                                  = new Country(new I18NString(Languages.en, "Andorra"),                                        "AD", "AND", 020, 376);
        public static readonly Country Angola                                   = new Country(new I18NString(Languages.en, "Angola"),                                         "AO", "AGO", 024, 244);
        public static readonly Country Anguilla                                 = new Country(new I18NString(Languages.en, "Anguilla"),                                       "AI", "AIA", 660, 1264);
        public static readonly Country Antarctica                               = new Country(new I18NString(Languages.en, "Antarctica"),                                     "AQ", "ATA", 010, 0);
        public static readonly Country AntiguaAndBarbuda                        = new Country(new I18NString(Languages.en, "Antigua and Barbuda"),                            "AG", "ATG", 028, 1268);
        ...
        public static readonly Country Benin                                    = new Country(new I18NString(Languages.en, "Benin"),                                          "BJ", "BEN", 204, 229);
        ...
        public static readonly Country Brazil                                   = new Country(new I18NString(Languages.en, "Brazil"),                                         "BR", "BRA", 076, 55);
        public static readonly Country BritishIndianOceanTerritory              = new Country(new I18NString(Languages.en, "British Indian Ocean Territory"),                 "IO", "IOT", 086, 246);
        public static readonly Country BritishVirginIslands                     = new Country(new I18NString(Languages.en, "British Virgin Islands"),                         "VG", "VGB", 092, 1284);
        ...
        public static readonly Country EquatorialGuinea                         = new Country(new I18NString(Languages.en, "Equatorial Guinea"),                              "GQ", "GNQ", 226, 240);
        public static readonly Country Eritrea                                  = new Country(new I18NString(Languages.en, "Eritrea"),                                        "ER", "ERI", 232, 291);
        public static readonly Country Estonia                                  = new Country(new I18NString(Languages.en, "Estonia"),                                        "EE", "EST", 233, 372);
        public static readonly Country Ethiopia                                 = new Country(new I18NString(Languages.en, "Ethiopia"),                                       "ET", "ETH", 231, 251);
        public static readonly Country FalklandIslands_Malvinas                 = new Country(new I18NString(Languages.en, "Falkland Islands (Malvinas)"),                    "FK", "FLK", 238, 500);
        public static readonly Country FaroeIslands                             = new Country(new I18NString(Languages.en, "Faroe Islands"),                                  "FO", "FRO", 234, 298);
        public static readonly Country Fiji                                     = new Country(new I18NString(Languages.en, "Fiji"),                                           "FJ", "FJI", 242, 679);
        public static readonly Country Finland                                  = new Country(new I18NString(Languages.en, "Finland"),                                        "FI", "FIN", 246, 358);
        public static readonly Country France                                   = new Country(new I18NString(Languages.en, "France"),                                         "FR", "FRA", 250, 33);
        public static readonly Country FrenchGuiana                             = new Country(new I18NString(Languages.en, "French Guiana"),                                  "GF", "GUF", 254, 594);
        public static readonly Country FrenchPolynesia                          = new Country(new I18NString(Languages.en, "French Polynesia"),                               "PF", "PYF", 258, 689);
        public static readonly Country FrenchSouthernTerritories                = new Country(new I18NString(Languages.en, "French Southern Territories"),                    "TF", "ATF", 260, 596);
        ...
        public static readonly Country Greenland                                = new Country(new I18NString(Languages.en, "Greenland"),                                      "GL", "GRL", 304, 229);
        public static readonly Country Grenada                                  = new Country(new I18NString(Languages.en, "Grenada"),                                        "GD", "GRD", 308, 1473);
        public static readonly Country Guadeloupe                               = new Country(new I18NString(Languages.en, "Guadeloupe"),                                     "GP", "GLP", 312, 590);
        public static readonly Country Guam                                     = new Country(new I18NString(Languages.en, "Guam"),                                           "GU", "GUM", 316, 1671);
        public static readonly Country Guatemala                                = new Country(new I18NString(Languages.en, "Guatemala"),                                      "GT", "GTM", 320, 502);
        public static readonly Country Guernsey                                 = new Country(new I18NString(Languages.en, "Guernsey"),                                       "GG", "GGY", 831, 44);
        public static readonly Country Guinea                                   = new Country(new I18NString(Languages.en, "Guinea"),                                         "GN", "GIN", 324, 224);
        public static readonly Country GuineaBissau                             = new Country(new I18NString(Languages.en, "Guinea-Bissau"),                                  "GW", "GNB", 624, 245);
        public static readonly Country Guyana                                   = new Country(new I18NString(Languages.en, "Guyana"),                                         "GY", "GUY", 328, 592);
        public static readonly Country Haiti                                    = new Country(new I18NString(Languages.en, "Haiti"),                                          "HT", "HTI", 332, 509);
        public static readonly Country HeardIslandAndMcdonaldIslands            = new Country(new I18NString(Languages.en, "Heard Island and Mcdonald Islands"),              "HM", "HMD", 334, 0);
        public static readonly Country Honduras                                 = new Country(new I18NString(Languages.en, "Honduras"),                                       "HN", "HND", 340, 504);
        public static readonly Country HongKong                                 = new Country(new I18NString(Languages.en, "Hong Kong"),                                      "HK", "HKG", 344, 852);
        public static readonly Country Hungary                                  = new Country(new I18NString(Languages.en, "Hungary"),                                        "HU", "HUN", 348, 36);
        public static readonly Country Iceland                                  = new Country(new I18NString(Languages.en, "Iceland"),                                        "IS", "ISL", 352, 354);
        public static readonly Country India                                    = new Country(new I18NString(Languages.en, "India"),                                          "IN", "IND", 356, 91);
        public static readonly Country Indonesia                                = new Country(new I18NString(Languages.en, "Indonesia"),                                      "ID", "IDN", 360, 62);
        public static readonly Country IslamicRepublicOfIran                    = new Country(new I18NString(Languages.en, "Islamic Republic of Iran"),                       "IR", "IRN", 364, 98);
        public static readonly Country Iraq                                     = new Country(new I18NString(Languages.en, "Iraq"),                                           "IQ", "IRQ", 368, 964);
        public static readonly Country Ireland                                  = new Country(new I18NString(Languages.en, "Ireland"),                                        "IE", "IRL", 372, 353);
        public static readonly Country IsleOfMan                                = new Country(new I18NString(Languages.en, "Isle of Man"),                                    "IM", "IMN", 833, 44);
        public static readonly Country Israel                                   = new Country(new I18NString(Languages.en, "Israel"),                                         "IL", "ISR", 376, 972);
        public static readonly Country Italy                                    = new Country(new I18NString(Languages.en, "Italy"),                                          "IT", "ITA", 380, 39);
        public static readonly Country Jamaica                                  = new Country(new I18NString(Languages.en, "Jamaica"),                                        "JM", "JAM", 388, 1876);
        //Jan Mayen+47 79
        public static readonly Country Japan                                    = new Country(new I18NString(Languages.en, "Japan"),                                          "JP", "JPN", 392, 81);
        public static readonly Country Jersey                                   = new Country(new I18NString(Languages.en, "Jersey"),                                         "JE", "JEY", 832, 44);
        public static readonly Country Jordan                                   = new Country(new I18NString(Languages.en, "Jordan"),                                         "JO", "JOR", 400, 962);
        public static readonly Country Kazakhstan                               = new Country(new I18NString(Languages.en, "Kazakhstan"),                                     "KZ", "KAZ", 398, 76);
        public static readonly Country Kenya                                    = new Country(new I18NString(Languages.en, "Kenya"),                                          "KE", "KEN", 404, 254);
        public static readonly Country Kiribati                                 = new Country(new I18NString(Languages.en, "Kiribati"),                                       "KI", "KIR", 296, 686);
        public static readonly Country DemocraticPeoplesRepublicOfKorea         = new Country(new I18NString(Languages.en, "Democratic People's Republic of Korea"),          "KP", "PRK", 408, 850);
        public static readonly Country RepublicOfKorea                          = new Country(new I18NString(Languages.en, "Republic of Korea"),                              "KR", "KOR", 410, 82);
        public static readonly Country Kuwait                                   = new Country(new I18NString(Languages.en, "Kuwait"),                                         "KW", "KWT", 414, 965);
        public static readonly Country Kyrgyzstan                               = new Country(new I18NString(Languages.en, "Kyrgyzstan"),                                     "KG", "KGZ", 417, 996);
        public static readonly Country LaoPDR                                   = new Country(new I18NString(Languages.en, "Lao PDR"),                                        "LA", "LAO", 418, 856);
        public static readonly Country Latvia                                   = new Country(new I18NString(Languages.en, "Latvia"),                                         "LV", "LVA", 428, 371);
        public static readonly Country Lebanon                                  = new Country(new I18NString(Languages.en, "Lebanon"),                                        "LB", "LBN", 422, 961);
        public static readonly Country Lesotho                                  = new Country(new I18NString(Languages.en, "Lesotho"),                                        "LS", "LSO", 426, 266);
        public static readonly Country Liberia                                  = new Country(new I18NString(Languages.en, "Liberia"),                                        "LR", "LBR", 430, 231);
        public static readonly Country Libya                                    = new Country(new I18NString(Languages.en, "Libya"),                                          "LY", "LBY", 434, 218);
        public static readonly Country Liechtenstein                            = new Country(new I18NString(Languages.en, "Liechtenstein"),                                  "LI", "LIE", 438, 423);
        public static readonly Country Lithuania                                = new Country(new I18NString(Languages.en, "Lithuania"),                                      "LT", "LTU", 440, 370);
        public static readonly Country Luxembourg                               = new Country(new I18NString(Languages.en, "Luxembourg"),                                     "LU", "LUX", 442, 352);
        public static readonly Country RepublicOfMacedonia                      = new Country(new I18NString(Languages.en, "Republic of Macedonia"),                          "MK", "MKD", 807, 389);
        public static readonly Country Macau                                    = new Country(new I18NString(Languages.en, "Macau"),                                          "MO", "MAC", 446, 835);
        public static readonly Country Madagascar                               = new Country(new I18NString(Languages.en, "Madagascar"),                                     "MG", "MDG", 450, 261);
        public static readonly Country Malawi                                   = new Country(new I18NString(Languages.en, "Malawi"),                                         "MW", "MWI", 454, 265);
        public static readonly Country Malaysia                                 = new Country(new I18NString(Languages.en, "Malaysia"),                                       "MY", "MYS", 458, 60);
        public static readonly Country Maldives                                 = new Country(new I18NString(Languages.en, "Maldives"),                                       "MV", "MDV", 462, 960);
        public static readonly Country Mali                                     = new Country(new I18NString(Languages.en, "Mali"),                                           "ML", "MLI", 466, 223);
        public static readonly Country Malta                                    = new Country(new I18NString(Languages.en, "Malta"),                                          "MT", "MLT", 470, 356);
        public static readonly Country MarshallIslands                          = new Country(new I18NString(Languages.en, "Marshall Islands"),                               "MH", "MHL", 584, 692);
        public static readonly Country Martinique                               = new Country(new I18NString(Languages.en, "Martinique"),                                     "MQ", "MTQ", 474, 596);
        public static readonly Country Mauritania                               = new Country(new I18NString(Languages.en, "Mauritania"),                                     "MR", "MRT", 478, 222);
        public static readonly Country Mauritius                                = new Country(new I18NString(Languages.en, "Mauritius"),                                      "MU", "MUS", 480, 230);
        ...
        public static readonly Country Montenegro                               = new Country(new I18NString(Languages.en, "Montenegro"),                                     "ME", "MNE", 499, 382);
        public static readonly Country Montserrat                               = new Country(new I18NString(Languages.en, "Montserrat"),                                     "MS", "MSR", 500, 1664);
        public static readonly Country Morocco                                  = new Country(new I18NString(Languages.en, "Morocco"),                                        "MA", "MAR", 504, 212);
        public static readonly Country Mozambique                               = new Country(new I18NString(Languages.en, "Mozambique"),                                     "MZ", "MOZ", 508, 258);
        public static readonly Country Myanmar                                  = new Country(new I18NString(Languages.en, "Myanmar"),                                        "MM", "MMR", 104, 264);
        public static readonly Country Namibia                                  = new Country(new I18NString(Languages.en, "Namibia"),                                        "NA", "NAM", 516, 264);
        public static readonly Country Nauru                                    = new Country(new I18NString(Languages.en, "Nauru"),                                          "NR", "NRU", 520, 674);
        ...
        public static readonly Country Niger                                    = new Country(new I18NString(Languages.en, "Niger"),                                          "NE", "NER", 562, 227);
        public static readonly Country Nigeria                                  = new Country(new I18NString(Languages.en, "Nigeria"),                                        "NG", "NGA", 566, 234);
        public static readonly Country Niue                                     = new Country(new I18NString(Languages.en, "Niue"),                                           "NU", "NIU", 570, 683);
        public static readonly Country NorfolkIsland                            = new Country(new I18NString(Languages.en, "Norfolk Island"),                                 "NF", "NFK", 574, 672);
        public static readonly Country NorthernMarianaIslands                   = new Country(new I18NString(Languages.en, "Northern Mariana Islands"),                       "MP", "MNP", 580, 1670);
        public static readonly Country Norway                                   = new Country(new I18NString(Languages.en, "Norway"),                                         "NO", "NOR", 578, 47);
        public static readonly Country Oman                                     = new Country(new I18NString(Languages.en, "Oman"),                                           "OM", "OMN", 512, 968);
        public static readonly Country Pakistan                                 = new Country(new I18NString(Languages.en, "Pakistan"),                                       "PK", "PAK", 586, 92);
        public static readonly Country Palau                                    = new Country(new I18NString(Languages.en, "Palau"),                                          "PW", "PLW", 585, 680);
        public static readonly Country PalestinianTerritory                     = new Country(new I18NString(Languages.en, "Palestinian Territory"),                          "PS", "PSE", 275, 970);
        public static readonly Country Panama                                   = new Country(new I18NString(Languages.en, "Panama"),                                         "PA", "PAN", 591, 507);
        public static readonly Country PapuaNewGuinea                           = new Country(new I18NString(Languages.en, "Papua New Guinea"),                               "PG", "PNG", 598, 675);
        public static readonly Country Paraguay                                 = new Country(new I18NString(Languages.en, "Paraguay"),                                       "PY", "PRY", 600, 595);
        public static readonly Country Peru                                     = new Country(new I18NString(Languages.en, "Peru"),                                           "PE", "PER", 604, 51);
        public static readonly Country Philippines                              = new Country(new I18NString(Languages.en, "Philippines"),                                    "PH", "PHL", 608, 63);
        public static readonly Country Pitcairn                                 = new Country(new I18NString(Languages.en, "Pitcairn"),                                       "PN", "PCN", 612, 64);
        public static readonly Country Poland                                   = new Country(new I18NString(Languages.en, "Poland"),                                         "PL", "POL", 616, 48);
        public static readonly Country Portugal                                 = new Country(new I18NString(Languages.en, "Portugal"),                                       "PT", "PRT", 620, 351);
        public static readonly Country PuertoRico                               = new Country(new I18NString(Languages.en, "Puerto Rico"),                                    "PR", "PRI", 630, 1787);
        public static readonly Country Qatar                                    = new Country(new I18NString(Languages.en, "Qatar"),                                          "QA", "QAT", 634, 974);
        public static readonly Country Réunion                                  = new Country(new I18NString(Languages.en, "Réunion"),                                        "RE", "REU", 638, 262);
        ...
        public static readonly Country SaintLucia                               = new Country(new I18NString(Languages.en, "Saint Lucia"),                                    "LC", "LCA", 662, 1758);
        public static readonly Country SaintMartin                              = new Country(new I18NString(Languages.en, "Saint-Martin (French part)"),                     "MF", "MAF", 663, 590);
        public static readonly Country SaintPierreAndMiquelon                   = new Country(new I18NString(Languages.en, "Saint Pierre and Miquelon"),                      "PM", "SPM", 666, 508);
        public static readonly Country SaintVincentAndGrenadines                = new Country(new I18NString(Languages.en, "Saint Vincent and Grenadines"),                   "VC", "VCT", 670, 1784);
        public static readonly Country Samoa                                    = new Country(new I18NString(Languages.en, "Samoa"),                                          "WS", "WSM", 882, 685);
        public static readonly Country SanMarino                                = new Country(new I18NString(Languages.en, "San Marino"),                                     "SM", "SMR", 674, 378);
        public static readonly Country SaoTomeAndPrincipe                       = new Country(new I18NString(Languages.en, "São Tomé and Príncipe"),                          "ST", "STP", 678, 239);
        public static readonly Country SaudiArabia                              = new Country(new I18NString(Languages.en, "Saudi Arabia"),                                   "SA", "SAU", 682, 966);
        public static readonly Country Senegal                                  = new Country(new I18NString(Languages.en, "Senegal"),                                        "SN", "SEN", 686, 221);
        public static readonly Country Serbia                                   = new Country(new I18NString(Languages.en, "Serbia"),                                         "RS", "SRB", 688, 381);
        ...
        public static readonly Country Sudan                                    = new Country(new I18NString(Languages.en, "Sudan"),                                          "SD", "SDN", 736, 249);
        public static readonly Country Suriname                                 = new Country(new I18NString(Languages.en, "Suriname"),                                       "SR", "SUR", 740, 597);
        public static readonly Country SvalbardAndJanMayenIslands               = new Country(new I18NString(Languages.en, "Svalbard and Jan Mayen Islands"),                 "SJ", "SJM", 744, 4779);
        public static readonly Country Swaziland                                = new Country(new I18NString(Languages.en, "Swaziland"),                                      "SZ", "SWZ", 748, 268);
        public static readonly Country Sweden                                   = new Country(new I18NString(Languages.en, "Sweden"),                                         "SE", "SWE", 752, 46);
        public static readonly Country Switzerland                              = new Country(new I18NString(Languages.en, "Switzerland"),                                    "CH", "CHE", 756, 41);
        public static readonly Country SyrianArabRepublic                       = new Country(new I18NString(Languages.en, "Syrian Arab Republic"),                           "SY", "SYR", 760, 963);
        public static readonly Country Taiwan                                   = new Country(new I18NString(Languages.en, "Taiwan"),                                         "TW", "TWN", 158, 886);
        public static readonly Country Tajikistan                               = new Country(new I18NString(Languages.en, "Tajikistan"),                                     "TJ", "TJK", 762, 992);
        public static readonly Country UnitedRepublicOfTanzania                 = new Country(new I18NString(Languages.en, "United Republic of Tanzania"),                    "TZ", "TZA", 834, 255);
        public static readonly Country Thailand                                 = new Country(new I18NString(Languages.en, "Thailand"),                                       "TH", "THA", 764, 66);
        public static readonly Country TimorLeste                               = new Country(new I18NString(Languages.en, "Timor-Leste"),                                    "TL", "TLS", 626, 0);
        public static readonly Country Togo                                     = new Country(new I18NString(Languages.en, "Togo"),                                           "TG", "TGO", 768, 228);
        public static readonly Country Tokelau                                  = new Country(new I18NString(Languages.en, "Tokelau"),                                        "TK", "TKL", 772, 690);
        public static readonly Country Tonga                                    = new Country(new I18NString(Languages.en, "Tonga"),                                          "TO", "TON", 776, 676);
        public static readonly Country TrinidadAndTobago                        = new Country(new I18NString(Languages.en, "Trinidad and Tobago"),                            "TT", "TTO", 780, 1868);
        public static readonly Country Tunisia                                  = new Country(new I18NString(Languages.en, "Tunisia"),                                        "TN", "TUN", 788, 216);
        public static readonly Country Turkey                                   = new Country(new I18NString(Languages.en, "Turkey"),                                         "TR", "TUR", 792, 90);
        public static readonly Country Turkmenistan                             = new Country(new I18NString(Languages.en, "Turkmenistan"),                                   "TM", "TKM", 795, 993);
        public static readonly Country TurksAndCaicosIslands                    = new Country(new I18NString(Languages.en, "Turks and Caicos Islands"),                       "TC", "TCA", 796, 1649);
        public static readonly Country Tuvalu                                   = new Country(new I18NString(Languages.en, "Tuvalu"),                                         "TV", "TUV", 798, 688);
        public static readonly Country Uganda                                   = new Country(new I18NString(Languages.en, "Uganda"),                                         "UG", "UGA", 800, 256);
        ...
        public static readonly Country Uzbekistan                               = new Country(new I18NString(Languages.en, "Uzbekistan"),                                     "UZ", "UZB", 860, 998);
        public static readonly Country Vanuatu                                  = new Country(new I18NString(Languages.en, "Vanuatu"),                                        "VU", "VUT", 548, 678);
        public static readonly Country VaticanState                             = new Country(new I18NString(Languages.en, "Vatican City State (Holy See)"),                  "VA", "VAT", 336, 379);

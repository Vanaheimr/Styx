...
namespace org.GraphDefined.Vanaheimr.Illias.Commons
{
    ...
    public static class IntegerExtensions
    {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this UInt32 Loops, Action_UInt32 Do)
        {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this Int64 Loops, Action_Int64 Do)
        {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this UInt64 Loops, Action_UInt64 Do)
        {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this Int32 Loops, Action_Int32_Int32 Do)
        {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this Int64 Loops, Action_Int64_Int64 Do)
        {
        ...
        /// <param name="Loops">The number of iterations.</param>
        /// <param name="Do">A delegate to call.</param>
        public static void Loop(this UInt64 Loops, Action_UInt64_UInt64 Do)
        {

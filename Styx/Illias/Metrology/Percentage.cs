...
namespace org.GraphDefined.Vanaheimr.Illias
{
                                        ...
                                        IComparable
    {
        ...
        /// </summary>
        /// <param name="Number">A numeric representation of a percentage.</param>
        public static Percentage Parse(Byte Number)
        {
        ...
        /// </summary>
        /// <param name="Number">A numeric representation of a percentage.</param>
        public static Percentage? TryParse(Byte Number)
        {
        ...
        /// <param name="Number">A numeric representation of a percentage.</param>
        /// <param name="Percentage">The parsed Percentage.</param>
        public static Boolean TryParse(Byte Number, out Percentage Percentage)
        {

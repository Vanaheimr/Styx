...
namespace org.GraphDefined.Vanaheimr.Illias
{
    ...
    /// </summary>
    public readonly struct PercentageDouble : IParsable  <PercentageDouble>,
                                              IEquatable <PercentageDouble>,
                                              ...
                                              ISubtractionOperators<PercentageDouble, PercentageDouble, PercentageDouble>
    {
        ...
        public static Boolean TryParse(Double                        Mean,
                                       Double                        StdDev,
                                       ...
                                       Int32?                        StdDevExponent   = null)
        {
            ...
            try
            {
                    ...
                    TryParse(StdDev, out var stddev))
                {
                    ...
                    Percentage = new StdDev<PercentageDouble>(mean, stddev);

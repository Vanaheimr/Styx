...
namespace org.GraphDefined.Vanaheimr.Illias
{
    ...
    ///
    /// PDF/A-3 is what lets an electronic invoice carry its own machine-readable
    /// data: the human-readable document and the structured data an accounting
    /// system needs travel as one file. ZUGFeRD and Factur-X work this way, and so
    /// does a charge transparency record attached to a charging invoice.
    /// </summary>
